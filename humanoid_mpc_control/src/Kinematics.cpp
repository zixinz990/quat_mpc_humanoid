...
namespace robot {
Eigen::Matrix<double, 3, 1> Kinematics::cal_left_foot_pos_body(const Eigen::Matrix<double, LEG_DOF, 1> joint_pos) {
    double b_t26[3];
    double t10;
    double t105;
    double t11;
    ...
    Eigen::Matrix<double, 3, 1> left_foot_pos_body;
    left_foot_pos_body << b_t26[0], b_t26[1], b_t26[2];

    return left_foot_pos_body;
}

Eigen::Matrix<double, 3, 1> Kinematics::cal_right_foot_pos_body(const Eigen::Matrix<double, LEG_DOF, 1> joint_pos) {
    double b_t26[3];
    double t10;
    double t105;
    double t11;
    ...
    Eigen::Matrix<double, 3, 1> right_foot_pos_body;
    right_foot_pos_body << b_t26[0], b_t26[1], b_t26[2];

    return right_foot_pos_body;
}
