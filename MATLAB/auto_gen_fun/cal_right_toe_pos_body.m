function right_toe_pos_body = cal_right_toe_pos_body(in1)
...
et3 = t67.*(-2.785e-1)+t69.*2.785e-1-t7.*t8.*5.764334763854388e-3-t8.*t12.*2.796853981665954e-3-t12.*t13.*1.363958719932164e-2+(t11.*t79)./1.6e+1-(t16.*t79)./2.5e+1;
et4 = t11.*(t67-t69).*(-1.0./2.5e+1)-(t16.*(t67-t69))./1.6e+1+2.276808032306545e-2;
et5 = t12.*1.574043082991271e-2+t17.*1.385e-2+t40.*2.4916e-1+t41.*1.306e-2+t52.*2.785e-1+(t11.*(t53+t10.*(t37-t41)))./1.6e+1-(t16.*(t53+t10.*(t37-t41)))./2.5e+1+t7.*t8.*2.84e-3-t8.*t12.*5.853258996236623e-3;
et6 = t12.*t13.*1.200235057712058e-3-t12.*t35.*1.183638142626072e-2+t12.*t36.*2.258156811766555e-1+(t11.*t77)./2.5e+1+(t16.*t77)./1.6e+1-t15.*(t37-t41).*2.785e-1-4.1e+1./5.0e+2;
...
et9 = t73.*(-2.785e-1)+t74.*2.785e-1-t7.*t8.*1.016408189284567e-3-t8.*t12.*4.931610337803473e-4-t12.*t13.*2.405028280935849e-3+(t11.*t81)./1.6e+1;
et10 = t16.*t81.*(-1.0./2.5e+1)-(t11.*(t73-t74))./2.5e+1-(t16.*(t73-t74))./1.6e+1-2.829081015999236e-1;
right_toe_pos_body = [et1+et2+et3+et4;et5+et6;et7+et8+et9+et10];
