...
//
// cal_left_foot_jac.cpp
//
// Code generation for function 'cal_left_foot_jac'
//

// Include files
#include "cal_left_foot_jac.h"
#include <cmath>

// Function Definitions
void cal_left_foot_jac(const double in1[5], double left_foot_jac[15])
{
  double t10;
  double t10_tmp;
  double t11;
  ...
  left_foot_jac[6] =
      ((((t67 * -0.24916 - t68 * 0.01306) + t76 * 0.01306) - t77 * 0.24916) -
       t86) -
      t88;
  left_foot_jac[7] = ((((t59 * -0.01306 + t60 * 0.24916) + t74) - t73) -
  ...
  left_foot_jac[8] =
      ((((t69 * -0.24916 - t70 * 0.01306) + t78 * 0.01306) - t36 * 0.24916) -
       t89) -
      t92;
  left_foot_jac[9] = -t86 - t88;
  left_foot_jac[10] = t74 - t73;
  left_foot_jac[11] = -t89 - t92;
  left_foot_jac[12] = 0.0;
  left_foot_jac[13] = 0.0;
  left_foot_jac[14] = 0.0;
}

// End of code generation (cal_left_foot_jac.cpp)
